...
public class AdjacencyList2 {
	...
	// Constructor
	public AdjacencyList2(int vertices) {
...
class testGraph {
	public static void main(String[] args) {
		...
		AdjacencyList2 adjacencyList2 = new AdjacencyList2(vertices);
		...
		while (i < edges) {
			...
			adjacencyList2.addEdge(u, v, weight);
			++i;
		}

		adjacencyList2.printAdjacencyList();
		adjacencyList2.removeEdge(0, new Pair<>(1, 1));
		adjacencyList2.printAdjacencyList();
	}
}
