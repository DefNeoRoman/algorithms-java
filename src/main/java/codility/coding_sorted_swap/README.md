...
that, given a non-empty zero-indexed array A consisting of N integers, returns 1 if the array can be sorted into non-decreasing order by performing at most one swap operation or 0 otherwise.
...
On the other hand, for the following array:
    ...
    A[3] = 3
    A[4] = 4
the function should return 0, as there is no single swap operation that sorts the array.
...
For the following array:
    ...
    A[1] = 3
    A[2] = 5
the function should return 1, as the given array is already sorted.
